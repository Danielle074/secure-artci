        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center gap-3">
            <div class="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
              ...
              <div class="ml-3 relative">
                ...
                >
                  <button class="w-full text-left px-3 py-1 hover:bg-gray-100" @click="selectYear(2024)">2024</button>
                  <button class="w-full text-left px-3 py-1 hover:bg-gray-100" @click="selectYear(2025)">2025</button>
                  <button class="w-full text-left px-3 py-1 hover:bg-gray-100" @click="selectYear(2026)">2026</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <router-link
              ...
              class="bg-orange-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-orange-600 transition flex items-center gap-2"
            >
